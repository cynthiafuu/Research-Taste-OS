...
def _rebuild_simple_dashboard(notion: NotionClient, page_id: str, paper_bank_id: str) -> None:
    ...
    notion.append_blocks(
        ...
        [
            ...
            callout(
                "Core rule: one paper gets one Paper Bank row; the full analysis lives inside that paper page.",
                "blue_background",
                "🎯",
            ),
            callout(
                "Reading path: PDF -> Paper Card -> Taste Memo -> Idea Extensions -> Scorecards -> My Judgment.",
                "gray_background",
                "🧭",
            ),
    ...
    notion.append_blocks(
        ...
        [
            ...
            bulleted("My Judgment: your own post-reading notes; this is the most important part of the system."),
        ],
    )
